...
| DeepSeek                   | LLM: generator AND reviewer (same-vendor review accepted by owner amendment, 2026-09-21; revisit when a second paid vendor key is provisioned) — receives the question and the assembled context, and reviews the draft against the retrieved sources | Chat question + context (both stages)                                                                                                                | Paid                    | Permitted (`personalDataAllowed: true`)                                                                                                    |
