...
export const messages = {
  en: {
    ...
    aboutPrivacyControllerLabel: "Data controller",
    aboutPrivacyProcessorsLabel: "Who processes your data",
    aboutPrivacyRoleLabel: "Role",
    aboutPrivacyDataLabel: "Personal data",
    aboutPrivacyStatusCurrent: "In use today",
    aboutPrivacyStatusTransition: "Transition",
    aboutPrivacyStatusPlanned: "Planned",
    aboutPrivacyStatusNoServingRole: "No serving role",
    aboutPrivacyTierPaid: "Paid",
    aboutPrivacyTierFree: "Free tier",
    aboutPrivacyVerdictPermitted: "May carry personal data",
    aboutPrivacyVerdictNotForPersonalData: "Not for personal data",
    aboutPrivacyPlannedPrefix: "planned",
    aboutPrivacyRetentionLabel: "How long it is kept",
    aboutPrivacyErasureLabel: "How to erase your data",
    aboutPrivacyStorageLabel: "What stays in your browser",
  ...
  id: {
    ...
    aboutPrivacyControllerLabel: "Pengendali data",
    aboutPrivacyProcessorsLabel: "Siapa yang memproses data Anda",
    aboutPrivacyRoleLabel: "Peran",
    aboutPrivacyDataLabel: "Data pribadi",
    aboutPrivacyStatusCurrent: "Dipakai hari ini",
    aboutPrivacyStatusTransition: "Transisi",
    aboutPrivacyStatusPlanned: "Direncanakan",
    aboutPrivacyStatusNoServingRole: "Tanpa peran melayani",
    aboutPrivacyTierPaid: "Berbayar",
    aboutPrivacyTierFree: "Tingkat gratis",
    aboutPrivacyVerdictPermitted: "Boleh membawa data pribadi",
    aboutPrivacyVerdictNotForPersonalData: "Bukan untuk data pribadi",
    aboutPrivacyPlannedPrefix: "direncanakan",
    aboutPrivacyRetentionLabel: "Berapa lama disimpan",
    aboutPrivacyErasureLabel: "Cara menghapus data Anda",
    aboutPrivacyStorageLabel: "Yang tersimpan di peramban Anda",
