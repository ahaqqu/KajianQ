...
export const messages = {
  en: {
    ...
    collectionAskAbout: "Ask about this source",
    collectionFilterAll: "All",
    collectionFilterGroup: "Filter collections",
  ...
  id: {
    ...
    collectionAskAbout: "Tanyakan sumber ini",
    collectionFilterAll: "Semua",
    collectionFilterGroup: "Saring koleksi",
