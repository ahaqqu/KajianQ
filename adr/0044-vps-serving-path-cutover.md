...
and CI-green, and the on-host application + cutover is the owner's step, gated
by `docs/VPS-CUTOVER-RUNBOOK.md`.
...
- `docs/VPS-CUTOVER-RUNBOOK.md` — the owner-executed cutover and its evidence
  checklist; `docs/VPS-HARDENING-RUNBOOK.md` — gains the Caddy teardown step.
