...
- The gate's vendor rule now has _no_ exempted source files; the exemption mechanism remains for genuine future needs, and the proof is structural (`.json` is unscanned) rather than a list of exceptions.
