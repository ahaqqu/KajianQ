...
| Backend runtime    | Deploy/dev/lifecycle tooling: VPS provisioning and the deploy script, migrations runner, CI workflows, secret binding and host preconditions      | `provision/vps/`, `.github/workflows/`, deploy scripts                                      |
